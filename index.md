...
> * 3、在活动中使用Menu:    public boolean onCreateOptionsMenu(Menu menu){getMenuInflater().inflate();return true;}public boolean onOptionsItemSelected(MenuItem item){switch(item.getItemId()){case                :break;default:}return true; }
